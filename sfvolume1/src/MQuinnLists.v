...
Proof.
  intros d x v. destruct x. simpl. rewrite <- beq_nat_refl. reflexivity. Qed.

Theorem update_neq : forall (d : partial_map) (x y : id) (o : nat),
  beq_id x y = false -> find x (update d y o) = find x d.
Proof.
  intros d x y o. intros H. simpl.
...
(* Type baz has no elements, because no constructor allows us to create
   an element of type baz without already having an element of type baz. *)
